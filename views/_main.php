...
<head>
    ...
    <script src="/util/myscript.js"></script>
    <script>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" id="nav_termek_lista" aria-current="page" href="?oldal=fo_oldal">Főoldal</a>
                    </li>
                    <?php if (isset($_SESSION['felhasznalo'])) : ?>
                        <li class="nav-item">
                            <a class="nav-link" id="nav_termek_insert" href="?oldal=termek_hozzaadasa">Termék hozzáadása</a>
                        </li>                        
                    <?php endif; ?>
                </ul>                
